...
export default function Widgets({newsResults, randomUsersResults}) {
  ...
  return (
    <div className="xl:w-[600px] hidden lg:inline ml-8 space-y-5"> 
        ...
        {/* search bar */}
        <div className="w-[80%] xl:w-[90%] sticky top-0 bg-white py-1.5 z-50">
        ...
        {/* What's happening */}
        <div className="text-gray-700 space-y-3 bg-gray-100 rounded-xl pt-2 w-[80%] xl:w-[90%]">
        ...
        {/* Who to follow */}
        <div className="text-gray-700 space-y-3 bg-gray-100 pt-2 rounded-xl w-[80%] xl:w-[90%]">
            ...
            key={randomUser.login.username}>
                 <img
                  ...
                  <div className="truncate ml-4 leading-5">
                    ...
                    <h5 className="text-[13px] truncate">{randomUser.name.first+" "+randomUser.name.last}</h5>
                  </div>
